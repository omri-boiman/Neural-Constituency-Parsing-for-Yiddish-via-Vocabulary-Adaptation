...
# ================= CONFIGURATION =================
# 🟢 NEW OUTPUT DIR: Separate this run from the previous ones
OUTPUT_DIR = './output/phase3_parser_scalar_12000'
...
# 🟢 INPUT: Pointing to your 12,000 step checkpoint
...
def train():
    ...
    args = {
        ...
        # 🟢 STRATEGY 2: SCALAR MIXING CONFIGURATION
        'finetune': False,           # Keep False to save memory (Course Constraint)
        'n_bert_layers': 12,         # 🌟 LOOK AT ALL 12 LAYERS (Was 4)
        'bert_pooling': 'scalar_mix',# 🌟 LEARN WEIGHTED AVERAGE (Was 'mean')
    ...
    print(f"🚀 Starting SCALAR MIXING Training for: {ENCODER_PATH}")
